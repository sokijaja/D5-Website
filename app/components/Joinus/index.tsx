        ...
        <div className="bg-joinus my-32">
            <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8'>
                ...
                <div className="text-center">
                    ...
                    <h2 className="text-4xl sm:text-6xl font-bold my-6 leading-10"> Stay Connected<br />with D5</h2>
                    <p className="text-lightblack text-base font-normal">Join our community and be the first to know about our latest projects,<br />industry insights, and exclusive offers.</p>
                </div>
                ...
                <div className="mx-auto max-w-4xl pt-5">
                    <div className="sm:flex items-center mx-5 p-5 sm:p-0 rounded-xl justify-between bg-lightgrey sm:rounded-full">
                        ...
                        <div className="sm:mr-3">
                            <button type="submit" className="joinButton w-full sm:w-0 text-xl text-white font-semibold text-center rounded-xl sm:rounded-full bg-navyblue hover:bg-btnblue">
                                Join!
                            </button>
                        </div>
                    </div>
